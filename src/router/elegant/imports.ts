...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "local-data_warframe_lich-sister": () => import("@/views/local-data/warframe/lich-sister/index.vue"),
  ...
  "local-data_warframe_night-wave": () => import("@/views/local-data/warframe/night-wave/index.vue"),
  ...
  "local-data_warframe_reward-pool": () => import("@/views/local-data/warframe/reward-pool/index.vue"),
  "local-data_warframe_riven-analyse": () => import("@/views/local-data/warframe/riven-analyse/index.vue"),
  "local-data_warframe_riven-tion-alias": () => import("@/views/local-data/warframe/riven-tion-alias/index.vue"),
  "local-data_warframe_riven-tion": () => import("@/views/local-data/warframe/riven-tion/index.vue"),
  "local-data_warframe_state-translation": () => import("@/views/local-data/warframe/state-translation/index.vue"),
