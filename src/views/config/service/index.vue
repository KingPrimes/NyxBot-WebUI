...
<template>
  <NSpace vertical :size="16">
    <NCard
      :title="$t('page.config.service.title')"
      :bordered="false"
      size="small"
      segmented
      class="card-wrapper"
    >
      ...
      >
        <NFormItem
          :label="$t('page.config.service.form.pluginPrefix', { type: serviceText })"
          path="pluginPrefix"
        >
        ...
        <NFormItem
          :label="$t('page.config.service.form.switchTo', { type: serviceText })"
          path="isServerOrClient"
        >
          <NSwitch
            v-model:value="formValue.isServerOrClient"
            @update:value="handleServiceTypeChange"
          />
        </NFormItem>

        <NFormItem
          v-if="!formValue.isServerOrClient"
          :label="`${serviceTypeText}URL`"
          path="wsClientUrl"
          required
        >
