...
const model = defineModel<Api.SystemConfig.WhitelistGroupSearchParams>('model', { required: true });
      ...
      <NCollapseItem :title="$t('common.search')" name="admin-search">
        <NForm ref="formRef" :model="model" label-placement="left" :label-width="80">
          <NGrid responsive="screen" item-responsive>
            <NFormItemGi
              span="24 s:12 m:6"
              :label="$t('page.config.whitelist.group.groupAccount')"
              path="groupAccount"
              class="pr-24px"
            >
              <NSelect
                ...
                :placeholder="$t('page.config.whitelist.group.placeholder')"
                clearable
              />
            </NFormItemGi>
