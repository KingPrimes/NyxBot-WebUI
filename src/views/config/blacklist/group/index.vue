...
const {
  ...
  apiFn: fetchGetBlacklistGroupList,
  showTotal: true,
  apiParams: {
    current: 1,
    size: 10
...
<template>
  <div class="min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
    <BlackSearch v-model:model="searchParams" @reset="resetSearchParams" @search="getDataByPage" />
    <NCard
      :title="$t('page.config.blacklist.group.title')"
      :bordered="false"
      size="small"
