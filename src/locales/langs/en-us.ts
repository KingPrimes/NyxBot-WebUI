  ...
  page: {
    ...
    log: {
      ...
      realtime: {
        ...
        level: 'Log Level',
        search: 'Search',
        searchPlaceholder: 'Search log content, package or thread',
        filterBtn: 'Filter',
        shareBtn: 'Share',
        export: 'Export',
        clear: 'Clear',
        ...
        filterPanel: {
          ...
          packagePlaceholder: 'Enter package name and press Enter',
          threadPlaceholder: 'Enter thread name and press Enter',
          reset: 'Reset Filter',
          apply: 'Apply Filter'
        }
      },
